...
void Timer_DisableInterrupt(void) { AT91C_BASE_AIC->AIC_IDCR = TIMER0_ID_MASK; }

void Timer_ResetSystemTime(void) { Timer_SetSystemTime(0); }
...
void Timer_EnableInterrupt(void) { AT91C_BASE_AIC->AIC_IECR = TIMER0_ID_MASK; }
