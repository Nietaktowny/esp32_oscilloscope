...
void testTemperatureSensorSampleReadyShouldReturnChannelConversionCompletionStatus(
    void) {
...
void testReadTemperatureSensorShouldFetchAndTranslateLatestReadingToMillivolts(
    void) {
  uint16 result;
