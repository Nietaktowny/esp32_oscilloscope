...
void tearDown(void) {
  ...
  if ((SetToOneMeanWeAlreadyCheckedThisGuy == 0) &&
...
void testInt64ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                         "Custom Message.");
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                         "Custom Message.");
#endif
}
...
void testInt64ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testInt64ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                         "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testInt64ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testInt64ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                         "Custom Message.");
#endif
}
...
void testIntArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                       "Custom Message.");
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                       "Custom Message.");
}
...
void testIntArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                       "Custom Message.");
  VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                       "Custom Message.");
  VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                       "Custom Message.");
  VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(110, expected, NULL, 3,
                                       "Custom Message.");
  VERIFY_FAILS_END
}
...
void testIntArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                       "Custom Message.");
}
...
void testInt16ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                         "Custom Message.");
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                         "Custom Message.");
}
...
void testInt16ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(110, expected, NULL, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt16ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                         "Custom Message.");
}
...
void testInt8ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                        "Custom Message.");
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 3,
                                        "Custom Message.");
}
...
void testInt8ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 0,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(11, NULL, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(11, expected, NULL, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testInt8ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(11, expected, expected, 3,
                                        "Custom Message.");
}
...
void testCHARArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                        "Custom Message.");
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 3,
                                        "Custom Message.");
}
...
void testCHARArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 0,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(11, NULL, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(11, expected, NULL, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testCHARArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(11, expected, expected, 3,
                                        "Custom Message.");
}
...
void testUInt64ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                          "Custom Message.");
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                          "Custom Message.");
#endif
}
...
void testUInt64ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                          "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testUInt64ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                          "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testUInt64ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                          "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testUInt64ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                          "Custom Message.");
#endif
}
...
void testUIntArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                        "Custom Message.");
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                        "Custom Message.");
}
...
void testUIntArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(110, expected, NULL, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUIntArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                        "Custom Message.");
}
...
void testUInt16ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                          "Custom Message.");
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                          "Custom Message.");
}
...
void testUInt16ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                          "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                          "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                          "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(110, expected, NULL, 3,
                                          "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt16ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                          "Custom Message.");
}
...
void testUInt8ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                         "Custom Message.");
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 3,
                                         "Custom Message.");
}
...
void testUInt8ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(11, expected, actualBigDelta, 0,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(11, NULL, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(11, expected, NULL, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testUInt8ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(11, expected, expected, 3,
                                         "Custom Message.");
}
...
void testHEX64ArrayWithinDelta(void) {
  ...
  TEST_IGNORE();
#else
  UNITY_UINT64 expected[] = {0xABCD123400000000, 0xABCD112200000000,
                             0xABCD127700000000};
  UNITY_UINT64 actualSmallDelta[] = {0xABCD123500000000, 0xABCD112100000000,
                                     0xABCD127700000000};
  UNITY_UINT64 actualBigDelta[] = {0xABCD126700000000, 0xABCD118800000000,
                                   0xABCD12AC00000000};
...
void testHEX64ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(
      0x100000000, expected, actualSmallDelta, 3, "Custom Message.");
  TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(0x6E00000000, expected, actualBigDelta,
                                         3, "Custom Message.");
#endif
}
...
void testHEX64ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(0x100000000, expected, actualBigDelta,
                                         3, "Custom Message.");
  VERIFY_FAILS_END
#endif
}
...
void testHEX64ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(0x6E00000000, expected, expected, 3,
                                         "Custom Message.");
#endif
}
...
void testHEX32ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                         "Custom Message.");
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                         "Custom Message.");
}
...
void testHEX32ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX32ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                         "Custom Message.");
}
...
void testHEX16ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                         "Custom Message.");
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 3,
                                         "Custom Message.");
}
...
void testHEX16ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(110, expected, actualBigDelta, 0,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(110, NULL, actualBigDelta, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(110, expected, NULL, 3,
                                         "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX16ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(110, expected, expected, 3,
                                         "Custom Message.");
}
...
void testHEX8ArrayWithinDeltaAndMessage(void) {
  ...
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(1, expected, actualSmallDelta, 3,
                                        "Custom Message.");
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(60, expected, actualBigDelta, 3,
                                        "Custom Message.");
}
...
void testHEX8ArrayNotWithinDeltaAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(1, expected, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaPointlessAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(60, expected, actualBigDelta, 0,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaExpectedNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(60, NULL, actualBigDelta, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaActualNullAndMessage(void) {
  ...
  EXPECT_ABORT_BEGIN
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(60, expected, NULL, 3,
                                        "Custom Message.");
  VERIFY_FAILS_END
}
...
void testHEX8ArrayWithinDeltaSamePointerAndMessage(void) {
  ...
  TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(60, expected, expected, 3,
                                        "Custom Message.");
}
