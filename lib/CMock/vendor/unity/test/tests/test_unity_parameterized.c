...
TEST_CASE(44)
TEST_CASE((90) + 9)
void test_TheseShouldAllPass(int Num) { TEST_ASSERT_TRUE(Num < 100); }
...
void test_NormalPassesStillWork(void) { TEST_ASSERT_TRUE(1); }
...
void test_StringsArePreserved(unsigned index, const char *str) {
  static const char *const expected[] = {"abc", "{", "}", ";", "\"quoted\""};
