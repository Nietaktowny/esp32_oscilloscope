...
// Optionally define the exception type (something like an int which can be
// directly assigned)
...
// Multi-Tasking environments will need a couple of macros defined to make this
// library properly handle  multiple exception stacks.  You will need to include
// and required definitions, then define the following macros:
//    EXCEPTION_GET_ID - returns the id of the current task indexed 0 to
//    (numtasks - 1) EXCEPTION_NUM_ID - returns the number of tasks that might
//    be returned
//
